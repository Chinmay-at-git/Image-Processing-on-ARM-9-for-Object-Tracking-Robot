...
int print_usage()
{
	...
	printf("\n detect_object [input RIF file] [output RIF file] <order of median filter> <Threshold Value>");
	printf("\n Order is optional , if not given , default order is 5, Range of Order is 0 to 50\n Threshold value is also optional, default 250");
...
int main(int argc, char *argv[]) {
   FILE *fid;
   clock_t t1,t2,t4,t3;
   unsigned char *data,*out,d=5,THR=250;
   signed char m,n,g;
